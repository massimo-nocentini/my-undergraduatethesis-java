...
public class OurModel implements DotExportable {
	...
	private OurModel(Set<Vertex> vertices) {
		this.name = "autogenerated_model_name";
	...
	public static OurModel makeOurModelFrom(String path) {
		...
		String model_name = connector.fetchModelName();
	...
	public static OurModel makeOurModelFrom(Set<Vertex> vertices, String name) {

		OurModel model = makeOurModelFrom(vertices);
		model.name = name;
